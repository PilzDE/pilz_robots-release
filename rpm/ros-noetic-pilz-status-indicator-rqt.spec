...
Name:           ros-noetic-pilz-status-indicator-rqt
Version:        0.6.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS pilz_status_indicator_rqt package
...
%description
Showing information about operation mode, status and speed override of the
robot.
